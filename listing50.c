...
int	main()
{
	...
	material material_ground = material_(lambertian, color_(0.8, 0.8, 0.0));
	material material_center = material_(lambertian, color_(0.7, 0.3, 0.3));
	material material_left = material_(metal, color_(0.8, 0.8, 0.8));
	material material_right = material_(metal, color_(0.8, 0.6, 0.2));
